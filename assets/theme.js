    ...
    productVariantCallback: function(variant) {
      ...
      if (variant) {
        ...
        if (variant.available) {
          ...
          this.settings.selectors.$addToCartText.html("カートに追加する");
          ...
          this.settings.selectors.$addToCartText.html("予約終了しました");
        ...
        if (this.settings.showComparePrice == 'true' ) {
          if (variant.compare_at_price > variant.price) {
            ...
            customPriceFormat += ' <span class="visually-hidden"><span class="visually-hidden">販売価格</span> ' + a11yPrice + '</span>';
          }
        }
        ...
        if ( variant.compare_at_price > variant.price ) {
          ...
          this.settings.selectors.$comparePrice.html("[$] OFF".replace('[$]', priceSaving)).show();
        } else {
